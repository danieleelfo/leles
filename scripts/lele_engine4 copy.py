...
# 💬 MAIN LOOP
def main():
    print("🏴‍☠️ Lele Engine FIXED v2 (stable)\n")
    ...
    while True:
        ...
        # STEP 2: GUARD
        if not gemma_out or gemma_out == "[EMPTY OUTPUT]":
            print("\n⚠️ Gemma failed → skipping Llama review")
            final = gemma_out
        else:
