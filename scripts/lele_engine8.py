...
def db_agent(user_input):
    # rimuove il prefisso "query" per passare solo la domanda reale
...
# 💬 MAIN LOOP
def main():
    print("🏴‍☠️ Lele Engine v8 (+ DB Agent)\n")

    while True:
        user_input = input("\n⚓ Tu ⭐: ").strip()

        if user_input.lower() in ["exit", "quit"]:
            print("🏴‍☠️ Arrivederci Capitano Psy e Marinaia semplice Denise. Statv bbun!!!")
            break
